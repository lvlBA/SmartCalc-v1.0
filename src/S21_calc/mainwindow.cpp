...
MainWindow::MainWindow(QWidget *parent)
  ...
  connect(ui->pushButton_leftScobe, SIGNAL(clicked()), this,
          SLOT(operations()));
  connect(ui->pushButton_rightScobe, SIGNAL(clicked()), this,
          SLOT(operations()));
...
void MainWindow::on_pushButton_DELETE_clicked() { ui->label_show->setText(""); }
